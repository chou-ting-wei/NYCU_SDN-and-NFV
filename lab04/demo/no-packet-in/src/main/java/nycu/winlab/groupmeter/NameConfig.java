...
public class NameConfig extends Config<ApplicationId> {
    ...
    private static final String MAC_3 = "mac-3";
    private static final String IP_1 = "ip-1";
    private static final String IP_2 = "ip-2";
    private static final String IP_3 = "ip-3";

    @Override
    public boolean isValid() {
        return hasOnlyFields(HOST_1, HOST_2, HOST_3, MAC_1, MAC_2, MAC_3, IP_1, IP_2, IP_3);
    }
    ...
    public ConnectPoint host3ConnectPoint() {
        return ConnectPoint.deviceConnectPoint(get(HOST_3, null));
    }
    ...
    public MacAddress mac3() {
        return MacAddress.valueOf(get(MAC_3, null));
    }
    ...
    public IpAddress ip3() {
        return IpAddress.valueOf(get(IP_3, null));
    }
}
